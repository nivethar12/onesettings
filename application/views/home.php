...
<html>
  ...
  <div class="container" id="hero-container">
    <div class="row">
	  ...
	  <div class="image col-xs-4 col-sm-6 col-md-6" style="overflow:hidden;padding-top:100px">
        <img src="img/factory.png" id="landing-image">
      </div>      
    
	  <div class="hero-text col-xs-8 col-sm-6 col-md-6" style="text-align:center">
